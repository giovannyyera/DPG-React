...
import imgConq1 from "../../Images/Assets/conquistas/gta.png";
import imgConq2 from "../../Images/Assets/conquistas/gta2.png";
import imgConq3 from "../../Images/Assets/conquistas/ta1.png";
...
import BgMain from '../../Images/Assets/Banners/fundoGTA.jpg';
        ...
        <div className={styles.libraryTop}>
          <div className={styles.gameInfo}>
            <div className={styles.logo}>
              <img src={logoGtaV} alt="img" className={styles.logoGtav}/> 
              {/* Logo     ^      Logo */}
            </div>
            <div className={styles.nameDateConq}>
              <div className={styles.nameDate}>
                <div className={styles.name}>Gta V</div>
