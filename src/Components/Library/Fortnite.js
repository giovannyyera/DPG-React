...
import imgConq1 from "../../Images/Assets/conquistas/fort.png";
import imgConq2 from "../../Images/Assets/conquistas/fort1.png";
import imgConq3 from "../../Images/Assets/conquistas/fort2.png";
...
import BgMain from '../../Images/Assets/Banners/fundoFortnite.png';
        ...
        <div className={styles.libraryTop}>
          <div className={styles.gameInfo}>
            <div className={styles.logo}>
              <img src={logoFortnite} alt="img" />
              {/* Logo     ^      Logo */}
            </div>
            <div className={styles.nameDateConq}>
              <div className={styles.nameDate}>
                <div className={styles.name}>Fortnite</div>
