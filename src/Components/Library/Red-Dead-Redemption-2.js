...
import imgConq1 from "../../Images/Assets/conquistas/red.png";
import imgConq2 from "../../Images/Assets/conquistas/red1.png";
import imgConq3 from "../../Images/Assets/conquistas/red2.png";
...
import BgMain from '../../Images/Assets/Banners/fundoRED.jpg';

function RedDeadRedemption(props) {
  useState(BgMain);
  useState(BgMain);
        ...
        <div className={styles.libraryTop}>
          <div className={styles.gameInfo}>
            <div className={styles.logo}>
              <img src={logoRedDeadRedemption} alt="img" />
              {/* Logo     ^      Logo */}
            </div>
            <div className={styles.nameDateConq}>
              <div className={styles.nameDate}>
                <div className={styles.name}>Red Dead Redemption</div>
...
export default RedDeadRedemption;
