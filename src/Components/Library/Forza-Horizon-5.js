...
import imgConq1 from "../../Images/Assets/conquistas/forza.png";
import imgConq2 from "../../Images/Assets/conquistas/forza1.png";
import imgConq3 from "../../Images/Assets/conquistas/forza2.png";
...
import BgMain from '../../Images/Assets/Banners/fundoForza.jpg';

function ForzaHorizon(props) {
  useState(BgMain);
  useState(BgMain);
        ...
        <div className={styles.libraryTop}>
          <div className={styles.gameInfo}>
            <div className={styles.logo}>
              <img src={logoForza} alt="img"/>
              {/* Logo     ^      Logo */}
            </div>
            <div className={styles.nameDateConq}>
              <div className={styles.nameDate}>
                <div className={styles.name}>Forza Horizon 5</div>
